...
<%
	...
	System.out.println("Received amountFrom: " + amountFrom);
	System.out.println("Received amountTo: " + amountTo);

	// Check if serviceId and other parameters are provided
	if (serviceId == null || serviceName == null || amountFrom == null || amountTo == null) {
		response.sendRedirect("getservcesuser.jsp?message=Invalid service details");
		return;
	}

	// Debugging - Print service details (remove in production)
	System.out.println("Service ID: " + serviceId);
	System.out.println("Service Name: " + serviceName);
	System.out.println("Amount From: " + amountFrom);
	System.out.println("Amount To: " + amountTo);
	...
	<div class="booking-container">
		<div class="booking-header">
		 ...
		 <form action="confirmBooking.jsp" method="POST" onsubmit="return validateform()" id="checkoutForm">
			...
			<div class="mb-3">
				<label for="amountRange" class="form-label">Amount Range</label> <input
					type="text" class="form-control" id="amountRange"
					value="&#x20B9; <%=amountFrom%> - &#x20B9; <%=amountTo%>"
					readonly>
			</div>

			<div class="mb-3">
				<label for="appointmentDate" class="form-label">Choose
			...
			<div class="d-flex justify-content-center mt-3">
				<button type="button" class="btn btn-custom" id="payBtn">Pay
					Now</button>
			</div>
		</form>
	</div>
